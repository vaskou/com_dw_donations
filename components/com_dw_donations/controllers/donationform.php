 ...
 */
class Dw_donationsControllerDonationForm extends Dw_donationsController {
    ...
    public function edit() {
        ...
        // Get the model.
        $model = $this->getModel('DonationForm', 'Dw_donationsModel');
    ...
    public function save() {
        ...
        if ($data === false) {
            ...
            $id = (int) $app->getUserState('com_dw_donations.edit.donation.id');
            $this->setRedirect(JRoute::_('index.php?option=com_dw_donations&view=donationform&layout=edit&id=' . $id, false));
            return false;
        }
        ...
        if ($return === false) {
            // Save the data in the session.
            $app->setUserState('com_dw_donations.edit.donation.data', $data);
        ...
        $item = $menu->getActive();
        $url = (empty($item->link) ? 'index.php?option=com_dw_donations&view=donations' : $item->link);
    ...
    function cancel() {
        ...
        $editId = (int) $app->getUserState('com_dw_donations.edit.donation.id');
    ...
    public function remove() {
        ...
        if (empty($data['id'])) {
            ...
            // Redirect back to the edit screen.
            $id = (int) $app->getUserState('com_dw_donations.edit.donation.id');
            $this->setRedirect(JRoute::_('index.php?option=com_dw_donations&view=donation&layout=edit&id=' . $id, false));
            return false;
        }
